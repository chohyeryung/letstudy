...
<head>
    ...
    <script type="text/javascript">
        function CheckForm(f){
            var chk_obj=document.getElementsByName("agree_checkbox");
...
<body>
    ...
    <form name="agree" class="agree_form" method="post" action="" onsubmit="CheckForm(this);">
        <fieldset>
        <h2 class="title_agree">이용약관 동의</h2>
            <div class="agree">
                <h3>제1장 총칙</h3>
                제1조(목적)<br>
                ...
                ② 본 약관에 명시되지 않은 사항은 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 전기통신기본법, 전기통신사업법, 정보통신윤리위원회심의규정, <br>정보통신 윤리강령, 프로그램보호법 등 관계법령과 개인정보 처리방침 및 행정안전부가 별도로 정한 지침 등의 규정에 따릅니다.<br>
                <br>
                제5조(회원정보의 통합관리)<br>
                당 사이트의 회원정보는 행정기관 타 사이트의 회원정보와 통합하여 관리될 수 있습니다.<br>
                <br>
                <h3>제2장 서비스 제공 및 이용</h3>
                ...
                ⑤ 당 사이트는 회원정보의 진위여부 및 소속기관의 확인 등을 위하여 확인절차를 거칠 수도 있습니다.<br>
                <br>
                제8조(사용자의 정보 보안)<br>
                ...
                ② 제1항의 이용시간은 정기점검 등의 필요로 인하여 당 사이트가 정한 날 또는 시간은 예외로 합니다.<br>
                <br>
                제10조(서비스의 중지 및 정보의 저장과 사용)<br>
                ① 귀하는 당 사이트 서비스에 보관되거나 전송된 메시지 및 기타 통신 메시지 등의 내용이 국가의 비상사태, 정전, 당 사이트의 관리 범위 외의 서비스 설비 장애 및 기타 불가항력에 의하여 보관되지 못하였거나 삭제된 경우, <br>전송되지 못한 경우 및 기타 통신 데이터의 손실이 있을 경우에 당 사이트는 관련 책임을 부담하지 아니합니다.<br>
                ② 당 사이트가 정상적인 서비스 제공의 어려움으로 인하여 일시적으로 서비스를 중지하여야 할 경우에는 서비스 중지 1주일 전의 고지 후 서비스를 중지할 수 있으며, 이 기간 동안 귀하가 고지내용을 인지하지 못한 데 대하여 당 사이트는 책임을 부담하지 아니합니다. <br>부득이한 사정이 있을 경우 위 사전 고지기간은 감축되거나 생략될 수 있습니다. 또한 위 서비스 중지에 의하여 본 서비스에 보관되거나 전송된 메시지 및 기타 통신 메시지 등의 내용이 보관되지 못하였거나 삭제된 경우, 전송되지 못한 경우 및 기타 통신 데이터의 손실이 있을 경우에 대하여도 당 사이트는 책임을 부담하지 아니합니다.<br>
                ...
                ⑥ 당 사이트에 장기간 접속을 하지 아니한 회원의 경우 이메일 또는 공지사항 등을 통한 안내 후 검토 기간을 거쳐 서비스 이용을 중지할 수 있습니다.<br>
                <br>
                ...
                ③ 당 사이트에 2년을 주기로 개인정보의 수집·이용에 대한 동의를 하지 아니한 회원의 경우 안내 메일 또는 공지사항 발표 후 검토 기간을 거쳐 회원의 정보를 삭제할 수 있습니다.<br>
                <br>
                ...
                ② 당 사이트는 서비스 제공과 관련하여 취득한 회원의 정보를 본인의 승낙 없이 타인에게 누설 또는 배포할 수 없으며, 상업적 목적으로 사용할 수 없습니다. <br>다만, 전기통신관련법령 등 관계법령에 의하여 관계 국가기관 등의 요구가 있는 경우에는 그러하지 아니합니다.<br>
                ...
                ⑤ 당 사이트는 서비스와 관련한 이용자의 불만사항이 접수되는 경우 이를 즉시 처리하여야 하며, 즉시 처리가 곤란한 경우 이용자에게 그 사유와 처리일정을 당 사이트, 전화, 이메일, 팩스 등으로 통보하여야 합니다.<br>
                <br>
                제16조(회원의 의무)<br>
                ...
                ② 귀하는 당 사이트가 명시적으로 승인한 경우를 제외하고는 전항의 소정의 각 재산에 대한 전부 또는 일부의 수정, 대여, 대출, 판매, 배포, 제작, 양도, <br>재라이센스, 담보권 설정 행위, 상업적 이용 행위를 할 수 없으며, 제3자로 하여금 이와 같은 행위를 하도록 허락할 수 없습니다.<br>
                <br>
                제18조 (양도금지)<br>
                ...
                ② 당 사이트는 서비스에 표출된 어떠한 의견이나 정보에 대해 확신이나 대표할 의무가 없으며 회원이나 제3자에 의해 표출된 의견을 승인하거나 반대하거나 수정하지 않습니다. <br>당 사이트는 어떠한 경우라도 회원이 서비스에 담긴 정보에 의존해 얻은 이득이나 입은 손해에 대해 책임이 없습니다.<br>
                ...
                <br>
                제21조 (관할법원)<br>
                본 사이트와 이용자 간에 발생한 서비스 이용에 관한 분쟁에 대하여는 대한민국 법을 적용하며, <br>본 분쟁으로 인한 소는 행정안전부 주소지의 관할 법원에 제기합니다.
                <br>
            </div>
        </fieldset>
        <div class="agree_check">
            이용약관에 동의하십니까?
            <input type="checkbox" name="agree_checkbox" value="check" />동의함
        </div>
        <fieldset>
        <h2 class="title2_agree">개인정보 수집 및 이용 동의</h2>
            <div class="agree2">
                ■ 수집 항목 <br>
                - 이름, 로그인ID, 비밀번호, 나이, 소속, 이메일<br>
                ■ 수집 및 이용 목적<br>
                회사는 수집한 개인정보를 다음의 목적을 위해 활용합니다.<br>
                - 회원관리<br>
                - 회원관리에 따른 본인확인, 나이, 소속을 확인함으로써 정확한 정보 제공<br>
                ■ 개인정보 보유 및 이용기간<br>
                - 회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이 해당 정보를 지체 없이 파기합니다.<br>
                ■ 동의거부관리<br>
                - 귀하께서는 본 안내에 따른 개인정보 수집, 이용에 대하여 동의를 거부하실 권리가 있습니다. <br>다만,
                귀하가 개인정보의 수집/이용에 동의를 거부하시는 경우에 불이익이 발생할 수<br>
                있음을 알려드립니다.<br>

            </div>
        </fieldset>
        <div class="agree2_check">
            개인정보 수집 및 이용에 동의하십니까?
            <input type="checkbox" name="agree_checkbox" value="check" />동의함
        </div>
        <input type="submit" class="button_submit" value="확인">
    </form>
    </center>
</body>
</html>